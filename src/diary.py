...
|18.using draw in pygame                                   |pygame.draw.rect(screen,(...),(...))         |
|19.using button in pygame                                 |Class Button:def init... atk_btn=Button(...) |
|20.using delta time                                       |delta_time=clock.tick(60)/1000               |
|21.using variable to fill a rect                          |pygame.draw.rect(..,(..),(..,.,wdth*atb,..)) |
|22.using event to detect clicks                           |if event.type==pygame.MOUSEBUTTONDOWN:...    |
